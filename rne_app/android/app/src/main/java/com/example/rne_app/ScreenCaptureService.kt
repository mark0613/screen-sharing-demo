...
class ScreenCaptureService : Service() {
        ...
        try {
                ...
                ByteArrayOutputStream().use { outputStream ->
                    ...
                    Handler(Looper.getMainLooper()).post {
                        sendEvent("screenCaptureEvent", Arguments.createMap().apply {
                            putString("type", "screenData")
                            putArray("imageBytes", Arguments.fromList(imageBytes.toList()))
                        })
                    }
                }
            ...
            Handler(Looper.getMainLooper()).post {
                sendEvent("screenCaptureEvent", Arguments.createMap().apply {
                    ...
                    putString("message", "螢幕擷取錯誤: ${e.message}")
                })
            }
        }
    }
    ...
    private fun sendEvent(eventName: String, params: WritableMap) {
        val bundle = Arguments.toBundle(params)
        val intent = Intent("SCREEN_CAPTURE_EVENT")
